		...
		<div class="controlselectScroll">
			...
			<div class="toolbar">
				<div class="title">
					...
					<div class="txt"><?php echo $lang->display('Create New Subject'); ?></div>
				</div>
				<div class="options">
					<!-- Save -->
					<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Save'); ?>">
						<a href="javascript:void(0);" onclick="validateForm('streamID','Stream','R','subject','Subject','R'); if(document.returnValue) { SubmitForm('newform','save'); }">
					...
					<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Apply'); ?>">
						<a href="javascript:void(0);" onclick="validateForm('streamID','Stream','R','subject','Subject','R'); if(document.returnValue) { SubmitForm('newform','apply'); }">
									...
									<td>
										...
										<?php
											...
											while ($row = mysql_fetch_assoc($result)) {
												echo '<option value="'.$row['streamID'].'">'.$row['streamTitle'].'</option>';
											}
										?>
										</select>
									</td>
