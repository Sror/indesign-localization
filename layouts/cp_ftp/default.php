		...
		<div class="controlselectScroll">
			...
			<div class="toolbar">
				...
				<div class="options">
					...
					<!-- Connect -->
					<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Connect'); ?>">
						<a href="javascript:void(0);" onclick="if(CheckSelected('listform','id')) { SubmitForm('listform','Connect'); }">
							<div class="ico"><?php echo '<img src="'.IMG_PATH.'toolbar/ico_sync.png">'; ?></div>
							<div><?php echo $lang->display('Connect'); ?></div>
						</a>
					</div>
					<!-- Edit -->
				...
				<div class="option">
					...
					<div class="right">
						<div class="filter">
							...
							>
							<?php BuildCompanyList($filter_company_id,$issuperadmin); ?>
							</select>
						</div>
					</div>
					<div class="clear"></div>
				...
				<div class="list">
					<table id="listview" width="100%" cellpadding="5" cellspacing="0" border="0">
						<tr>
                            ...
                            <th width="20%">
								<a href="javascript:void(0);" onclick="SetOrder('listform','ftp_memo','<?php echo $pre; ?>');">
									<?php echo $lang->display('FTP Memo'); ?>
								</a>
							</th>
							<th width="15%">
                            ...
                            <th width="4%" align="center">
								<a href="javascript:void(0);" onclick="SetOrder('listform','public','<?php echo $pre; ?>');">
									<?php echo $lang->display('Public'); ?>
								</a>
							</th>
							<th width="2%" align="center">
						...
						<?php
							...
							if($found) {
								...
								while($row = mysql_fetch_assoc($result)) {
									...
									if($row['public']==1) {
										echo '<a href="javascript:void(0);" onclick="goToURL(\'parent\',\'index.php?layout='.$layout.'&option=public&do=disable&id='.$row['id'].'\')"><img src="'.IMG_PATH.'ico_enable.png" title="'.$lang->display('Disable').'"></a>';
									} else {
										echo '<a href="javascript:void(0);" onclick="goToURL(\'parent\',\'index.php?layout='.$layout.'&option=public&do=enable&id='.$row['id'].'\')"><img src="'.IMG_PATH.'ico_disable.png" title="'.$lang->display('Enable').'"></a>';
									}
									echo '</td>';
