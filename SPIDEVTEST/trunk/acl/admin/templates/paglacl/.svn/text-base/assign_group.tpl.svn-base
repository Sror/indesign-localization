...
{include file="paglacl/acl_admin_js.tpl"}
  </head>
  <body onload="populate(document.assign_group.{$group_type}_section,document.assign_group.elements['objects[]'], '{$js_array_name}')">
    ...
    <form method="post" name="assign_group" action="assign_group.php">
      ...
      <table cellpadding="2" cellspacing="2" border="2" width="100%">
        ...
        <tr class="pager">
          <td colspan="5">
        {include file="paglacl/pager.tpl" pager_data=$paging_data link="?group_type=$group_type&group_id=$group_id&"}
          </td>
        </tr>
        <tr>
	<th>Section</th>
...
{/foreach}
  <tr class="pager">
    <td colspan="5">
      {include file="paglacl/pager.tpl" pager_data=$paging_data link="?"}
    </td>
  </tr>
  <tr class="controls" align="center">
    <td colspan="3">&nbsp;</td>
