<?php /* Smarty version 2.6.14, created on 2009-02-23 15:02:02
         compiled from paglacl/assign_group.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'paglacl/assign_group.tpl', 23, false),array('modifier', 'upper', 'paglacl/assign_group.tpl', 54, false),)), $this); ?>
...
s in Group: <b><?php echo $this->_tpl_vars['group_name']; ?>
        ...
        <tr class="pager">
          <td colspan="5">
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/pager.tpl", 'smarty_include_vars' => array('pager_data' => $this->_tpl_vars['paging_data'],'link' => "?group_type=".($this->_tpl_vars['group_type'])."&group_id=".($this->_tpl_vars['group_id'])."&")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
          </td>
...
<?php endforeach; endif; unset($_from); ?>
  <tr class="pager">
    <td colspan="5">
      <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/pager.tpl", 'smarty_include_vars' => array('pager_data' => $this->_tpl_vars['paging_data'],'link' => "?")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    </td>
