		...
		<div class="controlselectScroll">
			...
			<div class="toolbar">
				<div class="title">
					...
					<div class="txt"><?php echo $lang->display('Cost Manager').': '.$lang->display('New'); ?></div>
				</div>
				<div class="options">
					<!-- Save -->
					<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Save'); ?>">
						<a href="javascript:void(0);" onclick="validateForm('agency_id','Company','R','currency_id','Currency','R','rate','Cost per Page','RisNum','date','Valid From Date','R'); if(document.returnValue) SubmitForm('newform','save');">
					...
					<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Apply'); ?>">
						<a href="javascript:void(0);" onclick="validateForm('agency_id','Company','R','currency_id','Currency','R','rate','Cost per Page','RisNum','date','Valid From Date','R'); if(document.returnValue) SubmitForm('newform','apply');">
