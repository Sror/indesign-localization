		...
		<div class="controlselectScroll">
			...
			<div class="toolbar">
				<div class="title">
					...
					<div class="txt"><?php echo $lang->display('Language Manager'); ?></div>
				</div>
				<div class="options">
					<!-- New -->
			...
			<div class="mainwrap">
				...
				<div class="list">
					<table id="listview" width="100%" cellpadding="5" cellspacing="0" border="0">
						<tr>
							...
							<th>
								<a href="javascript:void(0);" onclick="SetOrder('listform','name','<?php echo $pre; ?>');">
									<?php echo $lang->display('Language Name'); ?>
								</a>
							</th>
						...
						<?php
							$query =  sprintf("SELECT languages.languageID AS id, languages.languageName AS name, languages.flag,
												COUNT(campaigns.campaignID) AS campaignno
												FROM languages
												LEFT JOIN campaigns ON languages.languageID = campaigns.sourceLanguageID
												WHERE languageName LIKE '%s'
