<?php
BuildHelperDiv($lang->display('FTP Manager'));
...
<div id="wrapperWhite">
	<div class="copyBar">
		<div class="title">
			<?php echo '<a href="javascript:void(0);" onclick="goToURL(\'parent\',\'index.php?layout=cp_ftp\');">'.$lang->display('FTP Manager').'</a> <img src="'.IMG_PATH.'arrow_subject.png"> '.$ftp_row['ftp_host']; ?>
		</div>
	</div>
									...
									<div class="list">
										<table width="100%" cellpadding="5" cellspacing="0" border="0">
											<tr>
												...
												<th>
													<a href="javascript:void(0);" onclick="hidediv('local_cache_info'); display('local_cache_loader'); DoAjax('id=<?php echo $ftp_id; ?>&dir=<?php echo $ftp_sync->local_get_current_dir(); ?>&sort=name&order=DESC','local_ftp','modules/mod_ftp_local.php');">
														<?php echo $lang->display('Name'); ?>
													</a>
												</th>
												<th align="right">
													<a href="javascript:void(0);" onclick="hidediv('local_cache_info'); display('local_cache_loader'); DoAjax('id=<?php echo $ftp_id; ?>&dir=<?php echo $ftp_sync->local_get_current_dir(); ?>&sort=size&order=DESC','local_ftp','modules/mod_ftp_local.php');">
														<?php echo $lang->display('Size'); ?>
													</a>
												</th>
												<th width="4%">
													<a href="javascript:void(0);" onclick="hidediv('local_cache_info'); display('local_cache_loader'); DoAjax('id=<?php echo $ftp_id; ?>&dir=<?php echo $ftp_sync->local_get_current_dir(); ?>&sort=type&order=DESC','local_ftp','modules/mod_ftp_local.php');">
														<?php echo $lang->display('Type'); ?>
													</a>
												</th>
												<th>
													<a href="javascript:void(0);" onclick="hidediv('local_cache_info'); display('local_cache_loader'); DoAjax('id=<?php echo $ftp_id; ?>&dir=<?php echo $ftp_sync->local_get_current_dir(); ?>&sort=date&order=DESC','local_ftp','modules/mod_ftp_local.php');">
														<?php echo $lang->display('Date Modified'); ?>
													</a>
												</th>
												<th width="4%">
													<a href="javascript:void(0);" onclick="hidediv('local_cache_info'); display('local_cache_loader'); DoAjax('id=<?php echo $ftp_id; ?>&dir=<?php echo $ftp_sync->local_get_current_dir(); ?>&sort=chmod&order=DESC','local_ftp','modules/mod_ftp_local.php');">
											...
											<?php
												...
												echo '<td></td>';
												echo '<td colspan="5"><a href="javascript:void(0);" onclick="hidediv(\'local_cache_info\'); display(\'local_cache_loader\'); DoAjax(\'id='.$ftp_id.'&dir='.$ftp_sync->local_go_parent_dir().'\',\'local_ftp\',\'modules/mod_ftp_local.php\');"><img src="'.IMG_PATH.'ico_up.png" title="'.$lang->display('Up').'" /></a></td>';
												echo '</tr>';
				...
				<div class="controlScroll">
					<div class="controlselectScroll">
						...
						<div class="toolbar">
							<div class="title">
								<div class="ico"><?php echo '<img src="'.IMG_PATH.'header/ico_folder.png">'; ?></div>
								<div class="txt"><?php echo $lang->display('Remote'); ?></div>
							</div>
							<div class="options">
								<!-- Refresh -->
								<div class="optionOff" onmouseover="this.className='optionOn'" onmouseout="this.className='optionOff'" title="<?php echo $lang->display('Refresh'); ?>">
