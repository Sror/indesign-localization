<?php /* Smarty version 2.6.14, created on 2009-02-07 00:57:16
         compiled from paglacl/acl_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'paglacl/acl_list.tpl', 57, false),array('function', 'cycle', 'paglacl/acl_list.tpl', 127, false),array('modifier', 'date_format', 'paglacl/acl_list.tpl', 226, false),)), $this); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/header.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/acl_admin_js.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  echo '
    <style type="text/css">
...
<body>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/navigation.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<table cellpadding="2" cellspacing="2" border="2" width="100%">
  <tr class="pager">
	<td colspan="8">
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/pager.tpl", 'smarty_include_vars' => array('pager_data' => $this->_tpl_vars['paging_data'],'link' => "?action=".($this->_tpl_vars['action'])."&filter_aco_section=".($this->_tpl_vars['filter_aco_section'])."&filter_aco=".($this->_tpl_vars['filter_aco'])."&filter_aro_section=".($this->_tpl_vars['filter_aro_section'])."&filter_aro=".($this->_tpl_vars['filter_aro'])."&filter_axo_section=".($this->_tpl_vars['filter_axo_section'])."&filter_axo=".($this->_tpl_vars['filter_axo'])."&filter_aro_group=".($this->_tpl_vars['filter_aro_group'])."&filter_axo_group=".($this->_tpl_vars['filter_axo_group'])."&filter_return_value=".($this->_tpl_vars['filter_return_value'])."&filter_allow=".($this->_tpl_vars['filter_allow'])."&filter_enabled=".($this->_tpl_vars['filter_enabled'])."&")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	</td>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "paglacl/footer.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>