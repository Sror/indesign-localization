 ...
 */
/**
 * acl_api Extended API Class
 *
 * Class acl_api should be used for applications that must interface directly with
 * PAGLACL's data structures, objects, and rules.
 *
 * @package PAGLACL
 *
 */

class acl_api extends acl {
	 ...
	 * get_version()
	 *
	 * Grabs paglacl version from the database.
	 *
	 * @return string Version of paglacl
	 */
	function get_version() {
		$query = "select value from ".$this->_db_table_prefix."paglacl where name = 'version'";
	 ...
	 * get_schema_version()
	 *
	 * Grabs paglacl schema version from the database.
	 *
	 * @return string Schema Version
	 */
	function get_schema_version() {
		$query = "select value from ".$this->_db_table_prefix."paglacl where name = 'schema_version'";
		$version = $this->db->GetOne($query);
	 ...
	 *
	 * @param array Output from acl_api->sorted_groups($group_type)
	 ...
	 * clear_database()
	 *
	 * Deletes all data from the PAGLACL tables. USE WITH CAUTION.
	 *
	 * @return bool Returns TRUE if successful, FALSE otherwise
	 *
	 */
